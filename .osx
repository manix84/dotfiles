...
sudo scutil --set ComputerName "RobBook Pro"
sudo scutil --set HostName "RobBook Pro"
sudo scutil --set LocalHostName "RobBook-Pro"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "RobBook-Pro"
...
# Turn off keyboard illumination when computer is not used for 20 seconds
defaults write com.apple.BezelServices kDimTime -int 20

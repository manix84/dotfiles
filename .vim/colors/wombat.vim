...
hi Statement        guifg=#8ac6f2               gui=none   ctermfg=105               cterm=bold
...
" Diff colors
hi DiffAdd          guifg=#000000 guibg=#95e454 gui=bold   ctermfg=0    ctermbg=154  cterm=bold
hi DiffChange       guifg=NONE    guibg=NONE    gui=none   ctermfg=NONE ctermbg=NONE cterm=none
hi DiffText         guifg=#000000 guibg=#95e454 gui=bold   ctermfg=0    ctermbg=154  cterm=bold
hi DiffDelete       guifg=#FFFFFF guibg=#e5786d gui=bold   ctermfg=15   ctermbg=124  cterm=bold
